...
- Параллельные задачи демонстрируют ускорение на больших массивах, хотя на маленьких массивах параллельная версия чуть медленнее из-за накладных расходов на потоки.  
